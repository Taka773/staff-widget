...
class My_Widget extends WP_Widget{
    ...
    $team_url = $instance['team_url'];
        ...
        <h5 class="thumbnail-josip-title text-bold text-black">',$team_name,'</h5>
        <p class="d-none d-lg-block text-italic text-black offset-top-0">',$team_rol,'</p>
      </div>
      <figcaption><a class="btn-java btn btn-block btn-rect text-lg-left" href="',$team_url,'">view full profile</a></figcaption>
     ';
 ...
 ?>
        ...
        <p>
            <label for="<?php echo $team_url_id; ?>">プロフィールURL:</label>
        </p>
